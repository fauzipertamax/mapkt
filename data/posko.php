...
$query = "SELECT unitid, initcap(unitname) as unitname FROM unit WHERE unittypeid=5 and unitparent = ".$cb." and isactive=1 ORDER by unitname ASC";
...
$myData = array('success' => true, 'posko' => $rayon);
