<?php
	...
	$sql="SELECT a.*,TO_CHAR(a.TANGGALLAPOR,'dd/mm/yyyy HH24:Mi:ss') AS TGL,TO_CHAR(a.TGLEKSEKUSI,'dd/mm/yyyy HH24:Mi:ss') AS TGLEKSEKUSI,CASE
  ...
  FROM MON_MOBILE_NEW2 a where a.id_tiket='".$idtiket."'and status !='Nyala (Catat Data Lap.)' order by id_tiket desc";
	 ...
	 // echo $sql;
            ...
            while ($row = oci_fetch_array($sqlq)) {
			 ...
			 $data['TGL'] = $row['TGL'];
			 $data['TGLEKSEKUSI'] = $row['TGLEKSEKUSI'];
