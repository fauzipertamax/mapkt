            ...
            items: [{
                ...
                items: [{
                    ...
                    handler: function() {
						...
						dataStore.proxy.url = 'data/api/gridStore.php';
                        dataStore.load({
                                scope: this,
					...
					Ext.getCmp('griddata').setLoading(true);
                        ...
                        if (filterForm.getForm().isValid() == true) {
							...
							{
                            dataStore.proxy.url = 'data/api/gridStore.php?cari=true&periodawal=' + awal + '&periodakhir=' + akhir + '&jcari=' + jcari +'&pcari='+pcari+'&d='+distribusi+'&c='+cabang+'&p='+posko;
                            dataStore.load({
                                scope: this,
                                callback: function(a, b, c) {
            ...
            items: [{
                ...
                viewConfig: {
                    ...
                    getRowClass: function(record) {
						...
						// notifikasi = record.get('NOTIFIKASI')
                        // if (notifikasi == '1')
                            // return 'Confirmed';
                        // if (notifikasi == '0')
                            // return 'Unconfirmed'
                ...
                columns: [{
                    ...
                    sortable: false,
                    dataIndex: 'ID_TIKET',
					renderer:function(v,m,r,a){
						if(r.data.NOTIFIKASI == 0){
							m.style="background-color:pink; height:210% !important;";
						}
						return v;
					}
					//tdCls: 'n-change-cell'		
                ...
                bbar: Ext.create('Ext.PagingToolbar', {
                    displayInfo: true,
                    store: dataStore,
                    displayMsg: 'Menampilkan laporan {0} - {2} dari {2}',
                                                    ...
                                                    load: function() {
                                                        ...
                                                        var addListenersOnMarkers = function(mark) {
                                                            ...
                                                            google.maps.event.addListener(mark, 'click', function(event) {
                                                                var contentString = ' <iframe width="400" height="355px" src="info/infodetil.php?nolapor=' + mark.nolapor + '&status=' + mark.status + '&tgl=' + mark.tglekse + '&user=' + mark.usernm + '&regu=' + mark.regu + '&gbr=' + mark.image + '" frameborder="0" />';
                                                        ...
                                                        var detailggStore = Ext.create('Ext.data.Store', {
                                                            fields: ['ID_TIKET', 'LATITUDE', 'LONGITUDE', 'STATUS', 'KODESTATUS', 'IDPEL', 'TGL','TGLEKSEKUSI', 'NAMAPELAPOR',
                                                                'ALAMATPELAPOR', 'TELPPELAPOR', 'CAUSE', 'ACTION', 'LASTSTATUS', 'IMAGE', 'ICON', 'USERNAME', 'NAMAREGU'
                                                            ],
                                                            proxy: {
                                                                type: 'ajax',
                                                                url: 'data/api/detailgridStore.php?id=' + paramsId,
                                                                actionMethods: {
                                                                    read: 'POST'
                                                                },
                                                                reader: {
                                                            ...
                                                            listeners: {
                                                                'load': function(a, b) {
																	...
																	for (var i = 0; i < b.length; i++) {
																		 titik = {lat: Number(b[i].data.LATITUDE), lng: Number(b[i].data.LONGITUDE)}; 																		 
																		 rute.push(titik);
																	}
