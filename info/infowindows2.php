...
var kd_userid="<?php echo $_GET['userid'];?>";
...
var rhistory = Ext.create('Ext.data.Store', {
    ...
    pageSize: 5,
       proxy: {
        type: 'ajax',
        url: 'historyregu2.php?userid='+kd_userid,
        reader: {
            type: 'json',
            root: 'ROW',
...
var rhistoryn = Ext.create('Ext.data.Store', {
    fields: ['REPORTNUMBER','LASTSTATUS'],
    pageSize: 5,
       proxy: {
        type: 'ajax',
        url: 'historyregu3.php?userid='+kd_userid,
        reader: {
            type: 'json',
            root: 'ROW',
            totalProperty: 'jumlah'
